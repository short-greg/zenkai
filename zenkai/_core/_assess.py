...
class Reduction(Enum):
    ...
    def __call__(
        ...
        Returns:
            torch.Tensor: The reduced loss
        """
        return self.forward(loss, dim, keepdim, reduction_override)
...
def reduce(
    ...
    """
    return Reduction[reduction].forward(assessment, dim)
...
class AssessmentLog(object):
    ...
    def __init__(self):
        ...
        self._log: typing.Dict[typing.Any, typing.Dict[str, typing.Dict[str, typing.Dict[str, torch.Tensor]]]] = {}
