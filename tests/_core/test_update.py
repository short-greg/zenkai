...
# local
from zenkai._core import _update
...
class TestRandUpdate:
    ...
    def test_rand_update_updates_the_original(self):
        ...
        new_ = _update.update_rand(cur, prev, 0.5)
    ...
    def test_rand_equals_original_if_prob_is_1(self):
        ...
        new_ = _update.update_rand(cur, prev, 1.0)
    ...
    def test_rand_equals_cur_if_prob_is_0(self):
        ...
        new_ = _update.update_rand(cur, prev, 0.0)
        assert ((new_ == cur)).all()
...
class TestMixCur:
    ...
    def test_rand_update_updates_the_original(self):
        ...
        new_ = _update.update_mix(cur, prev, 1.0)
...
class TestCalcSlope:
    ...
    def test_calc_slope_outputs_correct_size_with_one_dim(self):
        ...
        slope = _update.slope_calc(cur, assessment)
...
class TestScale:
    ...
    def test_calc_scale_returns_one_if_ref_same(self):
        ...
        x2 = torch.randn(4, 4)
        scale = _update.scale_calc(x2, x2)
