...
import torch
from zenkai.kaku import Assessment, Reduction, reduce_assessment
from zenkai.kaku._objective import Objective, Constraint, CompoundConstraint, impose, Itadaki
